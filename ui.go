...
<head>
    ...
    <script language='javascript'>
        ...
        $(document).ready(function () {
            aj = $.ajax({ url: "/ajax?act=ver", async: false });
            ret = aj.responseText;
            arr = ret.split("|");
            $("#tver").text("(Ver "+arr[0]+")");
            if (arr[1]!="null") {
    ...
    <div class="row-fluid ">
        <div class="span12 ">
            ...
            <div style="text-align:center">
                ...
                <h4>反馈,建议QQ群:<a target="_noblank" href="https://shang.qq.com/wpa/qunwpa?idkey=c5cb06c2e524eb7872f80317621bf51f9c0b1d3451451232dbe6aa3fbdbb15ff">23153821</a></h4>
            </div>
            ...
            <button class="btn btn-link" id="uver" type="button" hidden="hidden" onclick="window.open('https://github.com/Baozisoftware/Luzhibo-go/releases/download/latest/releases.7z')"></button>
            <table class="table ">
                <thead>
                <tr>
